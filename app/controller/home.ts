...
export default class HomeController extends Controller {
  ...
  public async insert() {
    ...
    try {
      ...
      const data = await this.service.home.insert(payload)
      this.stdout(ctx, data)
    } catch (err) {
...
* */
  public async delete() {
    ...
    try {
      ...
      const data = await this.service.home.delete(payload)
      this.stdout(ctx, data)
    } catch (err) {
  ...
  public async modify() {
    ...
    try {
      ...
      const data = await this.service.home.modify(payload.name, payload.greet)
      this.stdout(ctx, data)
    } catch (err) {
